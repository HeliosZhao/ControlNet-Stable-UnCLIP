...
'''
NOTE This one
Stable unCLIP checkpoints are finetuned from stable diffusion 2.1 checkpoints to condition on CLIP image embeddings. Stable unCLIP also still conditions on text embeddings. Given the two separate conditionings, stable unCLIP can be used for text guided image variation. 
...
class StableDiffusionControlNetUnCLIPPipeline(DiffusionPipeline, TextualInversionLoaderMixin):
    """
    ...
    def enable_model_cpu_offload(self, gpu_id=0):
        ...
        hook = None
        for cpu_offloaded_model in [self.text_encoder, self.image_encoder, self.unet, self.vae, self.controlnet]:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        ## NOTE the noise level influence the image embedding, can be tuned
        ...
        ## NOTE the shape of control image should be changed here
        ## NOTE it should be outside of the loop
