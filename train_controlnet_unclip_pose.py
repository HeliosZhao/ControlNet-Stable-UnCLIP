...
from controlnet.dataset import make_train_dataset_embed, collate_fn_embed, ControlNetPoseUnCLIPDataset
...
def main(cfg):
    ...
    train_dataset = ControlNetPoseUnCLIPDataset(cfg, tokenizer, feature_extractor)
